...
function FAQ() {
  return (
    <section className="container mx-auto p-4 md:px-10 lg:px-20 lg:py-36 font-cabinet flex justify-between lg:flex-row flex-col">
      <div className="w-[35%] bg-[#E9F6FF] p-8 space-y-8">
