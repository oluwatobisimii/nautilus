    ...
    <motion.div className=" w-full md:w-[48%] xl:w-[30%] border border-gray-200 bg-white hover:border-none hover:shadow-2xl hover:shadow-[#40a7f03b] group p-6 space-y-6 relative overflow-hidden">
      ...
      {overlay && (
        ...
        >
          ...
          <p className="text-lg font-medium leading-[180%] text-white">
            Our vision is to produce high-quality, reliable and user friendly
            services to our clients. We want to make our clients happy by
            creating world-class services that will definitely help in their day
            to day activities, marketing and branding.
          </p>
        </motion.div>
      )}
    </motion.div>
